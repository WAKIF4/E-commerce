...
const stripePromise = loadStripe("pk_test_51MmmQxJRhaJXfYdWgJUYB40An9jgWYUGO2sBp6BXrCF8m8ojmWyizd4PuOFnhrpTnxy8OR1HFw8RqZ4ENzmfZSD000SqDlW66D");
        ...
        <Container style={{ minHeight: "95vh" }} className="cart-container">
            <Row>
                <Col>
                    ...
                    {cart.length == 0 ? (
                        <Alert variant="info">Le panier d'achat est vide. Ajoutez des produits à votre panier.</Alert>
                    ) : (
                ...
                {cart.length > 0 && (
                    <Col md={5}>
                        <>
                            ...
                            <div>
                                <h3 className="h4 pt-4">Total: {user.cart.total} DH</h3>
                            </div>
                        </>
                    </Col>
                )}
